...
import { useEffect } from "react"; // For checking localStorage on component mount
...
function Login() {
  ...
  const submitValue = (event) => {
    ...
    axios.post(`${API_BASE_URL}/login`, data)
      //   .then((response) => {
      //     if (response && response.data && response.data.flag === "1") {
      //         const { name, id, user_id } = response.data;
      //         if (user_id) {
